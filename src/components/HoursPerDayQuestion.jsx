...
const HoursPerDayQuestion = ({ onNext, formData, updateFormData }) => {
    const [selectedOption, setSelectedOption] = useState(formData.hoursPerDay || '')
    ...
    const handleOptionSelect = (option) => {
        ...
        updateFormData('hoursPerDay', option)
    }
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center p-6 lg:p-12 pt-24 lg:pt-12 max-w-2xl mx-auto w-full">
            ...
            <div className="flex-1 flex flex-col justify-center">
                <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-8 lg:mb-12 leading-tight text-center lg:text-left">
                    How many hours can you spend here per day
                </h2>
                    ...
                    {options.map((option, index) => (
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                <div className={`w-5 h-5 lg:w-6 lg:h-6 rounded-full border-2 flex items-center justify-center ${selectedOption === option
...
export default HoursPerDayQuestion 